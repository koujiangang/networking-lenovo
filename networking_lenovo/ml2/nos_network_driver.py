...
class LenovoNOSDriver(object):
    ...
    def create_vlan(self, nos_host, vlanid, vlanname):
...
#        self._edit_config(nos_host, target='running', config=confstr)
    ...
    def disable_vlan_on_trunk_int(self, nos_host, vlanid, intf_type,
                                  interface):
    ...
    def create_and_trunk_vlan(self, nos_host, vlan_id, vlan_name,
                              intf_type, nos_port):
