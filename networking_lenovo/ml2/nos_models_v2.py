...
class NOSPortBinding(model_base.BASEV2):
    ...
    def __repr__(self):
        ...
        return ("<NOSPortBinding(%s,%s,%s,%s,%s,%s)>" %
                (self.port_id, self.vlan_id, self.vxlan_id, self.switch_ip, self.instance_id, self.processed))
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            self.vxlan_id == other.vxlan_id and
